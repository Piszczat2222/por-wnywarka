export const CATEGORIES = {
  ...
  travel: {
    ...
    seoDescription:
      'Budget Amazon travel backpacks, tumblers, and road trip essentials compared to premium brands. Vetted picks for smart travelers.',
  ...
  kitchen: {
    ...
    seoDescription:
      'Top 10 Amazon kitchen gadgets under $30 and budget alternatives to KitchenAid and viral appliances. Vetted for home cooks.',
  ...
  pets: {
    ...
    seoDescription:
      'Top 10 must-have Amazon gadgets for dog owners, puppy parents, and grooming. Vetted pet picks with honest reviews.',
  ...
  baby: {
    ...
    seoDescription:
      'Must-have Amazon baby products for new parents and top toddler-proofing gadgets. Vetted nursery and safety essentials.',
