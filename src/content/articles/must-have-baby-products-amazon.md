...
listItems:
  - rank: 1
    ...
    searchQuery: "Video Baby Monitor Night Vision Two Way Talk"
    priceApprox: "~$40–60"
    badge: "Editor's Pick"
    blurb: "Pan-tilt camera with night vision, two-way talk, and temperature sensor. Top-rated options on Amazon offer reliable monitoring without subscription fees."
  - rank: 2
  ...
  - rank: 3
    ...
    priceApprox: "~$18–25"
    badge: "Best Value"
    blurb: "Portable organizer for diapers, wipes, creams, and burp cloths. Moves from nursery to living room to car effortlessly."
  - rank: 4
    name: "Baby Bottle Warmer"
    searchQuery: "Baby Bottle Warmer Fast Even Heating"
    priceApprox: "~$25–40"
    blurb: "Heats bottles and baby food evenly with smart temperature control. Works with most bottle brands and sizes."
  - rank: 5
    name: "Nursing and Feeding Pillow"
    searchQuery: "Nursing Pillow Breastfeeding Bottle Feeding"
    priceApprox: "~$30–45"
    blurb: "Ergonomic support for breastfeeding and bottle feeding. Also works as a tummy-time prop and sitting aid as baby grows."
  - rank: 6
    name: "Baby Wipe Warmer"
    searchQuery: "Baby Wipe Warmer Moist"
    priceApprox: "~$22–35"
    blurb: "Keeps wipes warm and moist for less startling diaper changes. Especially appreciated during night feeds in winter."
  - rank: 7
    name: "Newborn Baby Carrier"
    searchQuery: "Newborn Baby Carrier Lightweight Easy On"
    priceApprox: "~$60–100"
    blurb: "Lightweight, easy-on carrier for newborns. Hands-free bonding from day one without complicated wrapping techniques."
  - rank: 8
  ...
  - rank: 9
    ...
    priceApprox: "~$5–8"
    blurb: "Rubber duck that displays \"HOT\" when bath water is too warm. Simple, cheap, and prevents accidental scalding."
  - rank: 10
