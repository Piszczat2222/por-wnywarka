...
listItems:
  ...
  - rank: 2
    ...
    priceApprox: "~$10–16"
    blurb: "High-density foam blocks bring the floor closer in forward folds and hip openers. Essential for beginners and tight hamstrings."
  - rank: 3
    name: "Yoga Strap (8-Foot)"
    searchQuery: "Yoga Strap 8 Foot D Ring"
    priceApprox: "~$7–12"
    badge: "Best Value"
    blurb: "Cotton strap with D-ring buckle for deepening stretches and assisted binds. Doubles as a mat carrier."
  - rank: 4
    name: "Yoga Knee Pad"
  ...
  - rank: 6
    ...
    priceApprox: "~$18–28"
    blurb: "Five loop bands with handles for pilates-style strength work. Adds glute and arm resistance to yoga flows."
  - rank: 7
    name: "Non-Slip Yoga Towel"
    searchQuery: "Yoga Towel Non Slip Hot Yoga"
    priceApprox: "~$12–20"
    blurb: "Microfiber overlay grips when wet. Stops sliding during sweaty vinyasa without buying a separate hot-yoga mat."
  - rank: 8
    name: "Yoga Bolster"
  ...
  - rank: 9
    ...
    priceApprox: "~$12–22"
    blurb: "Non-slip soles for reformer pilates and studio classes. Toe grip prevents sliding on polished floors."
  - rank: 10
