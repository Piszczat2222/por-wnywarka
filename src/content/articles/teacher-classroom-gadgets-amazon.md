...
listItems:
  - rank: 1
    name: "Label Maker"
    searchQuery: "Label Maker Laminated P Touch"
    priceApprox: "~$25–45"
    badge: "Editor's Pick"
    blurb: "Laminated labels survive backpacks, lockers, and supply bins. Every organized classroom starts here."
  - rank: 2
    name: "Thermal Laminator"
    searchQuery: "Thermal Laminator Two Roller Classroom"
    priceApprox: "~$30–45"
    blurb: "Protects anchor charts, center cards, and student badges from daily destruction. Two-roller heated system."
  - rank: 3
    name: "Wireless Presenter Remote"
    searchQuery: "Wireless Presenter Remote Laser Pointer"
    priceApprox: "~$20–35"
    badge: "Best Value"
    blurb: "Laser pointer and slide advancer with 50-foot range. Essential for assemblies, PD sessions, and parent nights."
  - rank: 4
    name: "Phone Document Camera Stand"
    searchQuery: "Phone Document Camera Stand Overhead"
    priceApprox: "~$15–28"
    blurb: "Positions phone overhead to project worksheets live. Budget document camera without district IT approval."
  - rank: 5
    name: "Sensory Fidget Bin Assortment"
    searchQuery: "Sensory Fidget Bin Assortment Classroom"
    priceApprox: "~$18–30"
    blurb: "Mixed fidgets for calm-down corners and focus breaks. Helps restless students self-regulate without disrupting class."
  - rank: 6
  ...
  - rank: 8
    ...
    priceApprox: "~$10–16"
    blurb: "Hang anchor charts, headphones, and hall passes on whiteboards and filing cabinets. No adhesive damage."
  - rank: 9
...
faq:
  - question: "How were these teacher classroom gadgets chosen?"
    answer: "We picked Amazon items with high review counts that teachers buy with their own money—organization, engagement, labeling, and comfort tools that survive a full school year."
  - question: "What price range are these classroom items?"
    answer: "Most picks fall between $10 and $35 on Amazon. We know teachers self-fund their classrooms, so every item justifies its price in daily utility."
