...
listItems:
  ...
  - rank: 3
    ...
    priceApprox: "~$12–20"
    blurb: "Soft foam corners for coffee tables, fireplaces, and sharp furniture edges. Pre-cut pieces with strong adhesive backing."
  - rank: 4
    name: "Stove Knob Covers"
    searchQuery: "Stove Knob Covers Childproof Universal"
    priceApprox: "~$10–14"
    blurb: "Clear covers prevent little hands from turning burners on. Universal fit for most standard stove knobs."
  - rank: 5
    name: "Door Finger Pinch Guards (6-Pack)"
    searchQuery: "Door Finger Pinch Guards 6 Pack Foam"
    priceApprox: "~$8–12"
    blurb: "Foam C-shaped guards clip onto doors to prevent finger pinches. Especially important for nursery and playroom doors."
  - rank: 6
  ...
  - rank: 7
    ...
    priceApprox: "~$8–12"
    blurb: "Keeps toilet lids closed. Prevents drowning risk and stops toddlers from flushing toys and phones."
  - rank: 8
    name: "Baby Gate Extension Kit"
...
- **Kitchen:** cabinet locks + stove knob covers first
- **Living room:** furniture anchors + corner guards
